...
# Docker plugin reports Jetty expression stack trace when editing a cloud definition
#
# https://issues.jenkins.io/browse/JENKINS-74xxx

JENKINS_WAR_VERSION=2.470
