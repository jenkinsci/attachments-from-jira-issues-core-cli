...
# Scriptler causing No such property: size for class: hudson.model.UpdateSite$Warning when using Java past version 11
#
# https://issues.jenkins.io/browse/JENKINS-73487

JENKINS_WAR_VERSION=2.468
