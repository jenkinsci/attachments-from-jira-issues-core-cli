...
# hudson.slaves.DumbSlave or one of its superclass overrides readResolve() without calling super implementation for plugin null
#
# https://issues.jenkins.io/browse/JENKINS-75607

JENKINS_WAR_VERSION=2.507
